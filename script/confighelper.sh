...
case $CHOICE in
        1)
			...
			do
				...
				dialog --title "Perfectrootserver Confighelper" --msgbox "Maybe you do not know what a number is?" $HEIGHT $WIDTH
				dialog --clear
				fi
			done
            ;;
...
# Todo
# Check 
#dialog --title "Perfectrootserver Confighelper" --msgbox $CONFIGHELPER_PATH/configs/userconfig.cfg 50 250
#dialog --clear
